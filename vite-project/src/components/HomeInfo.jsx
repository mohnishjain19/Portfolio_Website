...
const renderContent = {
  1:(
    ...
    Hi, I am <span className='font-semibold'>Mohnish </span>👋
    <br/>
  ...
  2:(
    ...
    3:(
      <InfoBox text="Led multiple projects to success over they years.Curiouis about the impact?" link='/projects'  btnText="Visit my portfolio"/>
      ),
      4:(
